...
- **Important tool results** that affect ongoing work (file contents, search
  results, errors)
...
Write in third person, past tense. Use bullet points for clarity. Output ONLY
the summary, no preamble or headers.
